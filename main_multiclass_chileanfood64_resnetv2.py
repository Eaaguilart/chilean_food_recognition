...
model.load_weights("chileanfood64_resnet_bs16.h5")
...
callbacks = [LearningRateScheduler(custom_scheduler(epochs)),
             tf.keras.callbacks.ModelCheckpoint("chileanfood64_resnet_bs16.h5", monitor="val_loss", save_best_only=True, save_weights_only=True),
